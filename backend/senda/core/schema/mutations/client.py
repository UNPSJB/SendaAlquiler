...
from senda.core.models.clients import Client, LocalityModel
from senda.core.schema.custom_types import ClientType
...
class UpdateClient(graphene.Mutation):
    ...
    def mutate(self, info: CustomInfo, id: str, client_data: UpdateClientInput):
        ...
        try:
            ...
            updated_client = Client.objects.update_client(
