...
class SupplierOrderProduct(models.Model):
    product = models.ForeignKey(ProductModel, on_delete=models.CASCADE, related_name="supplier_order")
    cant = models.IntegerField(max_length=255)
    supplier_order = models.ForeignKey(OrderSupplierModel, on_delete=models.CASCADE, related_name="orders")
