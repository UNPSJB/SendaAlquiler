...
class ProductOfficeModel(models.Model):
    office = models.ForeignKey(OfficeModel, on_delete=models.CASCADE, related_name='stock')
    product = models.ForeignKey(ProductModel, on_delete=models.CASCADE, related_name='stock') 
    stock = models.IntegerField()

class ProductSupplierModel(models.Model):
    product = models.ForeignKey(ProductModel, on_delete=models.CASCADE, related_name='suppliers')
    supplier = models.ForeignKey(SupplierModel, on_delete=models.CASCADE, related_name='products')
