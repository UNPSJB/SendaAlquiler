            ...
            <div className="container flex-1 bg-muted py-8">
                ...
                >
                    {({
                        ...
                        const salesByPeriodInterval = salesPerPeriod.reduce(
                            (acc, item) => {
                                const dateDayjs = dayjs(item.period);
                                acc[dateDayjs.format('DD/MM/YYYY')] = item;

                                return acc;
                            },
                            {} as Record<
                                string,
                                DashboardStatsQuery['dashboardStats']['salesPerPeriod'][0]
                            >,
                        );
